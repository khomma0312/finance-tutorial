...
// Clerk user ID
const SEED_USER_ID = "user_2lI8hSZr0oXqt8N44ZD8S2SqLGJ";
const SEED_CATEGORIES = [
  { id: "category_1", name: "Food", userId: SEED_USER_ID, plaidId: null },
  { id: "category_2", name: "Insurance", userId: SEED_USER_ID, plaidId: null },
  {
    id: "category_3",
    name: "Utilities",
    userId: SEED_USER_ID,
  ...
  { id: "category_7", name: "Travel", userId: SEED_USER_ID, plaidId: null },
